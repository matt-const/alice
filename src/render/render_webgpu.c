...
extern U32  js_webgpu_buffer_allocate   (U32 capacity, U32 mode);
extern void js_webgpu_buffer_download   (U32 buffer_handle, U32 offset, U32 bytes, void *data);
extern void js_webgpu_buffer_destroy    (U32 buffer_handle);

extern U32  js_webgpu_texture_allocate  (U32 format, U32 width, U32 height);
extern U32  js_webgpu_texture_download  (U32 texture_handle, U32 download_format, U32 x0, U32 y0, U32 x1, U32 y1, void *data);
extern U32  js_webgpu_texture_destroy   (U32 texture_handle);

extern U32  js_webgpu_sampler_create    (U32 near_mode, U32 far_mode);
extern void js_webgpu_sampler_destroy   (U32 sampler_handle);

extern U32  js_webgpu_shader_create     (U32 string_len, void *string_ptr);
extern U32  js_webgpu_shader_destroy    (U32 shader_handle);

extern U32  js_webgpu_pipeline_create   (U32 shader_handle, void *vertex_format_ptr);
extern U32  js_webgpu_pipeline_destroy  (U32 pipeline_handle);

extern void js_webgpu_frame_flush       (void *command_draw_ptr);

// ------------------------------------------------------------
// #-- Built-in shaders.

cb_global Str webgpu_shader_source_flat_2D = str_lit(
"@group(0) @binding(0)\n"
...
cb_function void webgpu_create_default_samplers(void) {
